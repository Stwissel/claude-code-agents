...
description: "Use this agent when you need to evaluate the quality of tests in a codebase against established testing best practices. This includes reviewing newly written tests, auditing existing test suites for quality improvements, or validating that tests follow TDD principles. Examples of when to use this agent:\\n\\n<example>\\nContext: The user has just written a new test file and wants to ensure it meets quality standards.\\nuser: \"I just wrote tests for the authentication module, can you review them?\"\\nassistant: \"I'll use the test-design-reviewer agent to evaluate your authentication tests against the Farley testing principles.\"\\n<commentary>\\nSince the user wants their tests reviewed for quality, use the Task tool to launch the test-design-reviewer agent to score and analyze the tests.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user completed a feature and its corresponding tests.\\nuser: \"Here's my implementation of the shopping cart feature with tests\"\\nassistant: \"Great implementation! Let me use the test-design-reviewer agent to analyze the quality of your tests and provide a Farley Score.\"\\n<commentary>\\nSince tests were written alongside the feature, proactively use the Task tool to launch the test-design-reviewer agent to ensure test quality.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user is concerned about flaky tests in their codebase.\\nuser: \"Our CI keeps failing randomly, I think we have flaky tests\"\\nassistant: \"I'll use the test-design-reviewer agent to analyze your test suite, particularly focusing on repeatability and isolation issues that cause flakiness.\"\\n<commentary>\\nSince the user is experiencing test reliability issues, use the Task tool to launch the test-design-reviewer agent to identify violations of the Repeatable and Atomic principles.\\n</commentary>\\n</example>"
model: opus
color: orange
---
